#!/usr/bin/env python3
"""
finetune.py — Sparse ResNet MAE Fine-tuning (NO occupancy ablation)
====================================================================
Loads encoder pretrained WITHOUT occupancy head.
Everything else identical to the full version for fair comparison.
